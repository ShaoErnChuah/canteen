...
if(isset($_POST['add_to_cart'])){
   ...
   if(mysqli_num_rows($select_cart) > 0){
      ...
      $insert_product = mysqli_query($conn, "INSERT INTO `cart`(name, price, image, quantity,user_name,foodID) VALUES('$product_name', '$product_price'
      , '$product_image', '$product_quantity','$user_id','$product_id')");
...
<section class="products">
                                ...
                                <div class="col-md-5">
                                    <div class="input-group mb-3">
                                        <select name="sort_numeric" class="form-control">
                                            ...
                                            <option value="low-high" <?php if(isset($_GET['sort_numeric']) 
                                            && $_GET['sort_numeric'] == "low-high") { echo "selected"; } ?> > Low - High</option>
                                            <option value="high-low" <?php if(isset($_GET['sort_numeric']) 
                                            && $_GET['sort_numeric'] == "high-low") { echo "selected"; } ?> > High - Low</option>
                                        </select>
   ...
   <div class="box-container">
      ...
      $select_products = mysqli_query($conn, "SELECT * FROM products WHERE type='rice' AND quantity>0  ORDER BY price $sort_option;");
